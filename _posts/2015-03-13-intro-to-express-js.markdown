...
{% highlight javascript lineanchors %}node app.js
{% endhighlight %}
...
{% highlight javascript lineanchors %}app.set("view engine", "html");
{% endhighlight %}
This sets up what hbs will render, in our case HTML
{% highlight javascript lineanchors %}app.engine("html", hbs.__express);
{% endhighlight %}
