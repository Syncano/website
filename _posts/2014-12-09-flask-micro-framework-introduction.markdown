...
{% highlight javascript lineanchors %}from flask import Flask
...
<h3>View:</h3>
{% highlight javascript lineanchors %}@app.route("/")
def hello():
    return "Hello World"
{% endhighlight %}
...
<h3>Run Server:</h3>
{% highlight javascript lineanchors %}app.run(debug=True)
{% endhighlight %}
...
{% highlight javascript lineanchors %}from flask import Flask, render_template
...
{% highlight javascript lineanchors %}from flask import render_template, request, jsonify, flash
from app import app
...
{% highlight javascript lineanchors %}@app.route("/", methods=["GET","POST"])
@app.route("/index", methods=["GET","POST"])
def index():
    return render_template("index.html")
{% endhighlight %}
...
<h3>Next you have:</h3>
{% highlight javascript lineanchors %}@app.route("/add/<int:first>/<int:second>",methods=["GET","POST"])
