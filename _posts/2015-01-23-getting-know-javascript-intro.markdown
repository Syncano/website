...
{% highlight javascript lineanchors %}document.getElementById([name of tag]).src = [new image source]{% endhighlight %}
&nbsp;

We do the same thing with the text displayed by the html as follows:
{% highlight javascript lineanchors %}document.getElementById([name of tag]).innerHTML = [new text]{% endhighlight %}
&nbsp;
...
{% highlight javascript lineanchors %}document.getElementById("changeable_text").style.color="blue";{% endhighlight %}
...
{% highlight javascript lineanchors %}document.getElementById("changeable_text").style.color="green";{% endhighlight %}
&nbsp;
...
{% highlight javascript lineanchors %}<HTML>
 <HEAD>
 <TITLE>Greeting</TITLE>
