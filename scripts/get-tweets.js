...
const tweetsIDsString = '712734440062074883,667455738139320320,650071291634946048,727236023298625537,717796429251497985';
...
T.get('statuses/lookup', { id: tweetsIDsString }, (err, data, response) => {
