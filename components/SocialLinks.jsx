  ...
  render() {
    ...
    return (
      <div className="links social-share">
        ...
        <a className="fa fa-pinterest" href={encodeURI(`http://pinterest.com/pin/create/button/?url=http://www.syncano.io${item.path}&description=${title}&media=http://www.syncano.io${image}`)} target="_blank"> </a>
      </div>
    )
  }
});