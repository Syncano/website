...
const PrivacyPolicy = () => (
  <Page opengraph>
    ...
    <div className='Header'>
      <Header
        title='Syncano Performance Insight EU-US Privacy Shield Policy'
    ...
    <div className='Section u-wrapper'>
      <Grid>
        ...
        <div className='Section__content'>
          <Text>
            <p>Syncano is committed to ensuring the privacy of your information. We have created this Privacy Policy to help explain about how we handle Information (collectively “Information”) that we receive from the European Economic Area (“EEA”) in connection with our product, Performance Insight.</p>
            <p>Syncano complies with the EU-US Privacy Shield Framework as set forth by the US Department of Commerce regarding the collection, use and retention of personal information from European Union member countries. Syncano has certified that it adhere to the Privacy Shield Principles of Notice, Choice, Accountability for Onward Transfer, Security, Data Integrity and Purpose Limitation, Access and Recourse, Enforcement and Liability. If there is any conflict between the policies in this privacy policy and the Privacy Shield Principles, the Privacy Shield Principles shall govern. To learn more about the Privacy Shield program, and to view our certification page, please visit <a href='https://www.privacyshield.gov/'>privacyshield.gov</a></p>
            ...
            <h3>What kind of Personal Information do Syncano collect?</h3>
            ...
            <h3>Why does Syncano collect your personal information?</h3>
            ...
            <h3>Notice</h3>
            <p>Syncano is a platform for app developers. You can create an app on the Service, and then all personal data will get stored on Syncano’s servers. Therefor Syncano does not collect Information from individuals directly. However, Information is received from affiliates or third-parties in the EEA for the purpose of providing technical support and maintenance. Syncano will use and disclose such information only in accordance with the notices provided by such entities. Types of data may include e.g., name, mailing or email address, biometric data etc.</p>

            <h3>Choice</h3>
            <p>Syncano is a data processor who cannot extend choice, therefore individuals will be referred to the entity with which they placed their original information. If an individual opts-out when the data is collected by the affiliate or third-party in the EEA, Syncano has no means of receiving that individual’s Information.</p>

            <h3>Onward Transfer</h3>
            <p>Syncano is not in the business of selling your information. We consider your personal information to be a vital part of our relationship with You. There are, however, certain circumstances in which we may share your personally identifiable information with certain third parties without further notice to You, as set forth below:</p>
            <ul>
              ...
              <li>Related Companies: We may also share your personally identifiable information with any entity that is affiliated with us for purposes consistent with this Privacy Policy. Syncano requires that the related companies either certify with the Privacy Shield agreement or enter into a written agreement with us that requires them to provide at least the same level of privacy protection as is required by the relevant Privacy Shield Principles.</li>
              <li>Agents, Consultants and Related Third Parties: Syncano, like many businesses, sometimes uses other companies to perform certain business-related functions. Examples of such functions include mailing information, maintaining databases and processing payments. Syncano requires that its agents and service providers either certify with the Privacy Shield agreement or enter into a written agreement with us that requires them to provide at least the same level of privacy protection as is required by the relevant Privacy Shield Principles.</li>
            ...
            <p>However, no method of transmission over the Internet or method of electronic storage is 100% secure. Therefore, while we strive to use commercially acceptable means to protect Your personally identifiable information, we cannot guarantee its absolute security. In cases of onward transfer to third parties of data of EU individuals received pursuant to the EU-US Privacy Shield, Syncano is therefore potentially liable.</p>
            ...
            <p>Nikolai Fasting, Privacy Officer</p>
            <div>Syncano, Inc. 60 Madison Avenue, Floor 12, New York, NY 10010</div>
            <p>privacy-officer@syncano.com</p>
