        ...
        <div className='Section__column Section__column--secondary'>
          <div className='Feature-list'>
            ...
            <div className='Feature Feature--full'>
              ...
              <p>Can’t find what you’re looking for in the Public Registry? Simply create your <a href='https://docs.syncano.io/#/building-sockets/basics'>own Syncano Sockets</a> in your very own Private Registry.</p>
