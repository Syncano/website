      ...
      <div className="home ">
        ...
        <div className="platforms" style={{paddingTop: 120, paddingBottom: 120, background: '#F6F6F6'}}>
          <div className="container">
            <div className="row text-center">
              ...
              <div className="col-md-1 hidden-md"></div>
              <div className="col-md-1 col-xs-3"><a href="http://docs.syncano.io/docs/ng-syncano" target="_blank"><img src={require('../images/angularjs-logo.png')} alt="AngularJS Logo"/></a></div>
              <div className="col-md-1 col-xs-3"><a href="http://docs.syncano.io/docs/ember-syncano" target="_blank"><img src={require('../images/logo-ember.png')} alt="EmberJS Logo"/></a></div>
        ...
        <div className="middleware text-center">
          <div className="container">
            ...
            <img src={require('../images/slider/slide3.jpg')} alt="slide3"/>
          </div>
