          ...
          <div className="row">
            ...
            <div className="col-md-8">
              ...
              <ul>
                ...
                <li>CodeBox gives you the ability to write and run any code on Syncano. A CodeBox is an object that contains a script that can be run on Syncano's code servers - think of it as a microservice. CodeBoxes can be run in several different ways - all depending on your apps' needs.</li>
