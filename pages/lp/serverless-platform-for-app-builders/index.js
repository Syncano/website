...
const ForAppBuildersLandingPage = (props, { modals }) => {
  return (
    <Hero
      headline={<span>Serverless platform<br />for app builders</span>}
...
ForAppBuildersLandingPage.contextTypes = {
  modals: React.PropTypes.object
};

export default ForAppBuildersLandingPage;
