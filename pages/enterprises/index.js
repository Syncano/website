...
const Enterprises = () => (
  <div>
    <PageHelmet
      title="Syncano for Enterprise"
      mixpanelTitle="Enterprise"
      description={`Is app development taking too long due to all features and functionalities that are just adding more
    ...
    />
    <PageHeader
      headline="Syncano for Enterprise"
