...
Install Ubuntu: {% highlight javascript lineanchors %}sudo apt-get install emacs{% endhighlight %}
...
{% highlight javascript lineanchors %}print "Hello there, my name is Eric and I like warm hugs"{% endhighlight %}
...
{% highlight javascript lineanchors %}public class Hello{
    public static void main(String[] args){
        System.out.println("Hello there, my name is Eric and I like warm hugs");
        }
    }{% endhighlight %}
And in C++
{% highlight javascript lineanchors %}#include <iostream>
using namespace std;
...
{% highlight javascript lineanchors %}print "Hello there"
...
You should see:
{% highlight javascript lineanchors %}$ python greeting.py # type this into the terminal (make sure you are in the right folder)
Hello there
...
{% highlight javascript lineanchors %}name = str(raw_input("What's your name?")){% endhighlight %}

is the same as,

{% highlight javascript lineanchors %}tmp = raw_input("What's your name?"){% endhighlight %}

{% highlight javascript lineanchors %}name = str(tmp){% endhighlight %}
...
{% highlight javascript lineanchors %}def f(x): 
    return x
